...
export function ListBusinessForm({ isOpen, onClose }: ListBusinessFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Then send email
      const response = await fetch('/.netlify/functions/business-leads-sendmail', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({ ...formData, recipientEmail: "bharathibct@gmail.com" }),
      });
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl max-w-lg w-full overflow-hidden flex flex-col"
          >
            {submitStatus === 'success' ? (
              ...
              <>
                {/* Fixed Header */}
                <div className="relative bg-gradient-to-r from-purple-600 to-indigo-600 p-8">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="p-8 max-h-[60vh] overflow-y-auto space-y-6 scroll-container">
                    <div>
