/*
  # Fix migration for aboutus_html column

  1. Changes
    - Properly handle column existence check
...
-- Note: We're not trying to access aboutus_html directly, we'll update it after
...
-- Update aboutus_html with formatted content
UPDATE members_new
