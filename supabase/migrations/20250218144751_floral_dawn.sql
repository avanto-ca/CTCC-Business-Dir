/*
  ...
  1. Storage Schema
    - Ensures storage schema exists with proper permissions
    - Creates required extensions
    - Sets up proper role grants
  
  2. Storage Setup
    - Creates storage.buckets table with proper structure
    - Creates storage.objects table with proper structure
...
GRANT ALL ON storage.buckets TO postgres, authenticated, anon;
GRANT ALL ON storage.objects TO postgres, authenticated, anon;
