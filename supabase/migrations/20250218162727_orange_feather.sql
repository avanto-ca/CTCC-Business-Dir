...
CREATE TABLE IF NOT EXISTS auth.users (
  ...
  email_confirmed_at timestamptz GENERATED ALWAYS AS (LEAST(COALESCE(phone_confirmed_at, 'infinity'::timestamptz), COALESCE(email_confirmed_at, 'infinity'::timestamptz))) STORED,
