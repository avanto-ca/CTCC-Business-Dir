/*
  # Fix member ID type conversion with proper column handling

  1. Changes
    - Properly handle type conversion between text and integer IDs
    - Ensure all columns exist before data migration
